    ...
    <AuthLayout title="Welcome Back" subtitle="Sign in to enter the arena">
      ...
      >
        ...
        <button
          type="button"
          onClick={fillDemo}
          className="w-full rounded-xl border border-dashed border-cyan-400/30 bg-cyan-400/5 px-4 py-3 text-left text-xs text-slate-300 transition-colors hover:bg-cyan-400/10"
        >
